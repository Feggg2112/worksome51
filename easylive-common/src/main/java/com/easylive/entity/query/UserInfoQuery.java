...
public class UserInfoQuery extends BaseParam {
	...
	public void setUserInfoFuzzy(String userInfoFuzzy){
		this.userInfoFuzzy = userInfoFuzzy;
	}

	public String getUserInfoFuzzy(){
		return this.userInfoFuzzy;
	}
